...
--  Purpose:
--         1. Assemble the data for batching Check Out service.
--  NOTE:
...
--         4. Copy the output to data file.
-- ===================================================================
with t_task_order as
 (select tto.ord_no, max(tto.task_order_no) last_task_order_no
   ...
   group by tto.ord_no)
select '{"MERGE_TASK_ORDER_NO":"' || a.merge_task_order_no || '", "OPER_DESC":"Check Out"},'  as resemble_data
